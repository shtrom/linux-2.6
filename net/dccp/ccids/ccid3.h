...
static inline enum ccid3_hc_rx_freeze_states ccid3_rx_freeze_get(struct ccid3_hc_rx_sock *hcrx)
{
...
static inline enum ccid3_hc_tx_freeze_states ccid3_tx_freeze_get(struct ccid3_hc_tx_sock *hctx)
{
